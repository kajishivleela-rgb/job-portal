...
const UpdateProfileDialog = ({open, setOpen}) => {
    ...
    return (
        <div>
            <Dialog open={open}>
                <DialogContent className="sm:max-w-md rounded-2xl shadow-xl" onInteractOutside={()=>setOpen(false)}>
                    <DialogHeader>
                    ...
                    <form onSubmit={submitHandler}>
                        <div className='grid gap-4 py-4'>
                            ...
                            <div className='grid grid-cols-4 items-center gap-4'>
                                ...
                                <Input id="number" name="number" value={input.mobile} onChange={changeEventHandler} className='col-span-3'/>
                            </div>
                            <div className='grid grid-cols-4 items-center gap-4'>
                        ...
                        <DialogFooter>
                            {
                                loading?<Button className="w-full my-4"><Loader2 className='mr-2 h-4w-4 animate-spin'/>Please wait</Button>:<Button type="submit" className="w-full mt-4 bg-blue-500 text-white py-2.5 rounded-lg font-medium transition-all duration-200 hover:bg-blue-600 active:scale-95">Update</Button>
                            }
                        </DialogFooter>
                    </form>
                </DialogContent>
