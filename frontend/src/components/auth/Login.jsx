    ...
    <div>
      ...
      <div className="flex items-center justify-center">
        <form onSubmit={submitHandler} className="w-full max-w-md border border-gray-200 rounded-md p-8 bg-white shadow-md space-y-6">
          ...
          {
            loading?<Button className="w-full my-4"><Loader2 className='mr-2 h-4w-4 animate-spin'/>Please wait</Button>:<Button type="submit" className="w-full mt-4 bg-blue-500 text-white py-2.5 rounded-lg font-medium transition-all duration-200 hover:bg-blue-600 active:scale-95">Login</Button>
