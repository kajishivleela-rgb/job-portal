        ...
        <div>
            ...
            <div className='max-w-xl mx-auto my-10'>
                <form onSubmit={submitHandler}>
                    ...
                    {
                        loading?<Button className="w-full my-4"><Loader2 className='mr-2 h-4w-4 animate-spin'/>Please wait</Button>:<Button type="submit" className="w-full mt-4 bg-blue-500 text-white py-2.5 rounded-lg font-medium transition-all duration-200 hover:bg-black-600 active:scale-95">Update</Button>
                    }                
                </form>
            </div>
        </div>
