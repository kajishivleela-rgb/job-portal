    ...
    const applyJobHandler = async()=>{
        try {
            ...
            if(res.data.success){
                ...
                dispatch(setSingleJob(updatedSingleJob)); //helps us to real time ui updation
    ...
    return (
        <div className='max-w-7xl mx-20 my-10'>
            <div className='flex items-center justify- between'>
                ...
                <Button onClick={isApplied?null:applyJobHandler} className={`ml-auto rounded-lg ${isApplied?'bg-gray-600 cursor-not-allowed':'bg-[#7209b7] hover:bg-[#5f32ad]'}`}>{isApplied ?'Already Applied':'Apply Now'}</Button>
            </div>
